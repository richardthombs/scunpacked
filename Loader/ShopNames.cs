...
namespace Loader
{
	public static class ShopNames
	{
		public static Dictionary<string, string> Lookup = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
		{
			...
			{ "DumpersDepot_Grimhex", "Dumper's Depot, Grim Hex" },
			{ "DumpersDepot_Levski", "Dumper's Depot, Levski" },
			{ "PlatinumBay_Stanton1_LEO1", "Platinum Bay, Hurston LEO1" },
			{ "PlatinumBay_Stanton3_LEO1", "Platinum Bay, ArcCorp LEO1" },
			{ "Skutters_Food_GrimHex", "Skutters, Grim Hex"},
			...
			{ "LandingServices_GrimHex", "Landing Services, Grim Hex" },
			...
			{ "HDShowcase_Lorville", "Hurston Dynamics Showcase, Loreville" },
			...
			{ "OmegaPro_NewBabbage", "Omega Pro, NewBabbage" },
